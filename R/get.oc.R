                    ...
                    ntrial = 1000, seed = 6, fix3p3 = FALSE)
{
  ...
  if (cohortsize > 1) {
    temp = get.boundary(target, ncohort, cohortsize, n.earlystop=ncohort*cohortsize,
                        p.saf = p.saf, p.tox = p.tox, lambda1 = lambda1, lambda2 = lambda2, cutoff.eli, extrasafe, fix3p3 = fix3p3)$full_boundary_tab
  }
  else {
    temp = get.boundary(target, ncohort, cohortsize, n.earlystop=ncohort*cohortsize,
                        p.saf = p.saf, p.tox = p.tox, lambda1 = lambda1, lambda2 = lambda2, cutoff.eli, extrasafe, fix3p3 = fix3p3)$boundary_tab
  }
  print(temp)
  b.e = temp[2, ]
  b.d = temp[3, ]
